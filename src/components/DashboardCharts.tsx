...
export function DashboardCharts({
    ...
    return (
        <div className="grid gap-4 sm:gap-4 md:gap-6 lg:gap-6 xl:gap-8 md:grid-cols-2">
            ...
            <div className="flex flex-col items-center justify-center space-y-3 md:space-y-4 rounded-xl border border-white/10 bg-white/5 p-5 md:p-6 backdrop-blur-sm">
            ...
            {/* Bar Breakdown */}
            <div className="flex flex-col justify-center space-y-3 md:space-y-4 rounded-xl border border-white/10 bg-white/5 p-5 md:p-6 backdrop-blur-sm">
