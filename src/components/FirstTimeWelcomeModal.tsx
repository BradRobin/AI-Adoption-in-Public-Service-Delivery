                  ...
                  <div className="mt-6 flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                      ...
                      <button
                        ...
                        className="inline-flex h-12 w-full min-w-0 items-center justify-center rounded-xl bg-green-500 px-6 text-base font-bold text-white shadow-[0_18px_45px_-25px_rgba(74,222,128,0.95)] transition hover:-translate-y-0.5 hover:bg-green-400 sm:w-auto sm:min-w-60"
                      >
